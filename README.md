...
<table>
  ...
  <tr>
    ...
    <tr>
    <td><a href="https://github.com/Tourist7/Yandex.Prakticum-DS/blob/main/first.ipynb">Определение перспективного тарифа для телеком компании</a></td>
...
,numpy</td>
    ...
    <tr>
    <td><a href="https://github.com/Tourist7/Yandex.Prakticum-DS/blob/main/first.ipynb">Изучение закономерностей определяющих успешность игр</a></td>
...
numpy</td>
    ...
    <tr>
    <td><a href="https://github.com/Tourist7/Yandex.Prakticum-DS/blob/main/first.ipynb">Прогнозирование подходящего тарифа для пользователя</a></td>
...
sklearn</td>
    ...
    <tr>
    <td><a href="https://github.com/Tourist7/Yandex.Prakticum-DS/blob/main/first.ipynb">Предсказание оттока клиентов из банка</a></td>
...
sklearn</td>
    ...
    <tr>
    <td><a href="https://github.com/Tourist7/Yandex.Prakticum-DS/blob/main/first.ipynb">Предсказание лучшего места для скважины</a></td>
...
sklearn</td>
    ...
    <tr>
    <td><a href="https://github.com/Tourist7/Yandex.Prakticum-DS/blob/main/first.ipynb">Подготовка прототипа модели для металлообрабатывающего предприятия</a></td>
...
sklearn</td>
    ...
    <tr>
    <td><a href="https://github.com/Tourist7/Yandex.Prakticum-DS/blob/main/first.ipynb">Разработка алгоритма для защиты данных</a></td>
...
sklearn</td>
    ...
    <tr>
    <td><a href="https://github.com/Tourist7/Yandex.Prakticum-DS/blob/main/first.ipynb">Предсказание цены автомобиля</a></td>
...
sklearn,catboost,lightgbm,xgboost</td>
  ...
  <tr>
    <td><a href="https://github.com/Tourist7/Yandex.Prakticum-DS/blob/main/first.ipynb">Прогнозирование заказов такси на следующий час</a></td>
...
sklearn,catboost,lightgbm,xgboost</td>
  ...
  <tr>
    <td><a href="https://github.com/Tourist7/Yandex.Prakticum-DS/blob/main/first.ipynb">Классификация комментариев</a></td>
...
transformers,Bert,DistilBert,re,lightgbm</td>
  ...
  <tr>
    <td><a href="https://github.com/Tourist7/Yandex.Prakticum-DS/blob/main/first.ipynb">Исследование предпочтения пользователей, покупающих билеты на разные направления</a></td>
...
seaborn</td>
  ...
  <tr>
    <td><a href=https://github.com/Tourist7/Yandex.Prakticum-DS/blob/main/first.ipynb">Определение возраста по фото</a></td>
...
numpy</td>
  ...
  <tr>
    <td><a href="https://github.com/Tourist7/Yandex.Prakticum-DS/blob/main/first.ipynb">Отток клиентов в телекоме</a></td>
